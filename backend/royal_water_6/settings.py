"""
Django settings for royal_water_6 project.
...
ROOT_URLCONF = 'royal_water_6.urls'
...
WSGI_APPLICATION = 'royal_water_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "royal_water_6 API",
    "DESCRIPTION": "API documentation for royal_water_6 App",
    "VERSION": "v1",
}
